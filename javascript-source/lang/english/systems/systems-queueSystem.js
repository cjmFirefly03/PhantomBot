...
$.lang.register('queuesystem.open.normal', 'The queue is now opened! Use !queue [optional gamertag] to join it! $1');
$.lang.register('queuesystem.open.limit', 'The queue is now opened! Max entries are $1 users. Use !queue [optional gamertag] to join it! $2');
...
$.lang.register('queuesystem.join.error.joined', 'You are currently position #$1 in the queue.');
...
$.lang.register('queuesystem.position.self', 'You are currently position #$1 in the queue.');
$.lang.register('queuesystem.position.self.error', 'You are currently not in the queue.');
$.lang.register('queuesystem.position.other', '$1 is currently position #$2 in the queue.');
...
$.lang.register('queuesystem.usage', 'Usage: !queue [open / close / clear / next / pick');
